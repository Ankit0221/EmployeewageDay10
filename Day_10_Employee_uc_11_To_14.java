...
public class Day_10_Employee_uc_11_To_14 {
	...
	public Day_10_Employee_uc_11_To_14(String company, int empPerHrWage, int numOFWorkingDays, int totalHourPerMonth) {
	...
	public static class EmpWageBuilder implements IEmployeeWageCompution {
		...
		private LinkedList<Day_10_Employee_uc_11_To_14> employeeWageComputionsList;
		private Map<String, Day_10_Employee_uc_11_To_14> employeeWageComputionMap;
		...
		public void addCompanyEmpWage(String company, int empPerHrWage, int numOFWorkingDays, int totalHourPerMonth) {
			Day_10_Employee_uc_11_To_14 employeeWageCompution = new Day_10_Employee_uc_11_To_14(company, empPerHrWage,
		...
		public void empWageCompute() {
			for (int i = 0; i < employeeWageComputionsList.size(); i++) {
				Day_10_Employee_uc_11_To_14 employeeWageCompution = employeeWageComputionsList.get(i);
		...
		public int empWageCompute(Day_10_Employee_uc_11_To_14 employeeWageCompution) {
			int empHour = 0;
			int totalEmpHrs = 0;
